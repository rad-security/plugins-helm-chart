...
| bootstrapper.image.tag | string | `"v1.1.33"` |  |
...
| guard.image.tag | string | `"v1.1.43"` |  |
...
| runtime.agent.image.tag | string | `"v0.1.45"` |  |
...
| runtime.exporter.image.tag | string | `"v0.1.45"` |  |
...
| watch.image.tag | string | `"v1.1.49"` |  |
