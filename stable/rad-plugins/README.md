...
| runtime.agent.image.tag | string | `"v0.1.44"` |  |
...
| runtime.exporter.image.tag | string | `"v0.1.44"` |  |
...
| watch.image.tag | string | `"v1.1.48"` |  |
