...
| bootstrapper.image.tag | string | `"v1.1.30"` |  |
...
| guard.image.tag | string | `"v1.1.40"` |  |
...
| runtime.agent.image.tag | string | `"v0.1.43"` |  |
...
| runtime.exporter.image.tag | string | `"v0.1.43"` |  |
...
| watch.image.tag | string | `"v1.1.47"` |  |
