...
To use a private ECR Registry, you need to add and configure a proper AWS IAM role with the necessary permissions. For more details see: [Scanning images from ECR](https://docs.rad.security/docs/scanning-images-from-ecr).
...
| bootstrapper.image.tag | string | `"v1.1.18"` |  |
...
| guard.image.tag | string | `"v1.1.24"` |  |
