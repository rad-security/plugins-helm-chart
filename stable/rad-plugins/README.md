...
| bootstrapper.image.tag | string | `"v1.1.29"` |  |
...
| guard.image.tag | string | `"v1.1.39"` |  |
...
| runtime.agent.image.tag | string | `"v0.1.42"` |  |
...
| runtime.exporter.image.tag | string | `"v0.1.42"` |  |
...
| watch.image.tag | string | `"v1.1.46"` |  |
