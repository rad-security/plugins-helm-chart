...
| bootstrapper.image.tag | string | `"v1.1.28"` |  |
...
| guard.image.tag | string | `"v1.1.38"` |  |
...
| runtime.agent.image.tag | string | `"v0.1.41"` |  |
...
| runtime.exporter.image.tag | string | `"v0.1.41"` |  |
...
| watch.image.tag | string | `"v1.1.45"` |  |
