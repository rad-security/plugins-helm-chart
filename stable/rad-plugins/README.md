...
| bootstrapper.image.tag | string | `"v1.1.17"` |  |
...
| guard.image.tag | string | `"v1.1.23"` |  |
...
| runtime.agent.image.tag | string | `"v0.1.23"` |  |
...
| watch.image.tag | string | `"v1.1.32"` |  |
