...
| bootstrapper.image.tag | string | `"v1.1.25"` |  |
...
| guard.image.tag | string | `"v1.1.34"` |  |
...
| runtime.agent.image.tag | string | `"v0.1.36"` |  |
...
| runtime.exporter.image.tag | string | `"v0.1.36"` |  |
...
| watch.image.tag | string | `"v1.1.42"` |  |
