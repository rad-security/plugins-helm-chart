...
VALUES_FILE_PATH="./stable/rad-plugins/values.yaml"
CHART_FILE_PATH="./stable/rad-plugins/Chart.yaml"

HELM_CHART_VERSION=$(yq e ".version" "$CHART_FILE_PATH")
HELM_CHART_REPO="rad-security/rad-plugins"

RELEASE_NOTES_URL="https://github.com/rad-security/plugins-helm-chart"
       ...
       "DeliveryOptions": [
         {
           "Details": {
             "HelmDeliveryOptionDetails": {
               ...
               "Description": "The RAD Security plugins are deployed in your EKS cluster with our Helm chart. The chart is open source and can be viewed here",
               "HelmChartUri": "709825985650.dkr.ecr.us-east-1.amazonaws.com/\($HELM_CHART_REPO):\($HELM_CHART_VERSION)",
               "QuickLaunchEnabled": false,
               "UsageInstructions": "To install RAD Security through the AWS Marketplace, refer to our documentation on [Installing RAD Security In The AWS Marketplace](https://docs.rad.security/docs/installing-ksoc-in-the-aws-marketplace)",
               "ReleaseName": "rad-plugins",
               "Namespace": "rad",
               "OverrideParameters": [
                  {
                    "Key": "rad.clusterName",
                    "Metadata": {
                      "Obfuscate": false,
                      "Label": "RAD Cluster Name",
                      "Description": "The name of the cluster you wish to give to within the RAD Security Platform"
                    }
                  },
                  {
                    "Key": "rad.base64AccessKeyId",
                    "Metadata": {
                      "Obfuscate": true,
                      "Label": "Base64 Access Key",
                      "Description": "The base64 encoded acess key given through the UI or the API of RAD Security"
                    }
                  },
                  {
                    "Key": "rad.base64SecretKey",
                    "Metadata": {
                      "Obfuscate": true,
                      "Description": "The base64 encoded secrt key given through the UI or the API of RAD Security",
